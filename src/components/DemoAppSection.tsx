...
export default function DemoAppSection() {
  ...
  return (
    <>
      ...
      {/* Premium Modal - Portal Style */}
      {showModal && selectedDemo && (
        <div 
          className="fixed inset-0 z-[9999] bg-black/80 backdrop-blur-md animate-fadeIn overflow-y-auto"
          onClick={handleCloseModal}
        >
          <div className="min-h-screen flex items-center justify-center p-4 md:p-8">
            <div 
              className="relative w-full max-w-7xl animate-slideUp"
              onClick={(e) => e.stopPropagation()}
            >
              {/* Close Button */}
              <button
                onClick={handleCloseModal}
                className="fixed top-6 right-6 z-[10000] flex items-center justify-center w-12 h-12 rounded-full bg-white/10 backdrop-blur-md text-white hover:bg-white/20 hover:rotate-90 transition-all duration-300"
              >
              ...
              <div className="flex flex-col lg:flex-row gap-6 w-full">
                ...
                <div className="lg:w-1/3 bg-gradient-to-br from-white/95 to-white/90 backdrop-blur-xl rounded-3xl p-6 md:p-8 shadow-2xl flex flex-col justify-between lg:sticky lg:top-8 lg:self-start">
                  <div>
                ...
                <div className="lg:w-2/3 flex items-center justify-center py-8">
